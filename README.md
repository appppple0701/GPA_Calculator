...
# feature : 
-Supports 4.0 and 4.3 GPA scales(switchable).
-Import grades from excel using standard template. 
-Downloadable Excel template with column notes to guide correct input.
-Trend analysis:

This tool is designed for users who follow the official template format; invalid inputs will be rejected clearly.
